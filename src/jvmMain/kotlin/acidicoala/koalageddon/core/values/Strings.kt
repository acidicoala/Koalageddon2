...
sealed class Strings(
    ...
    object Turkish : Strings(
        ...
        buildTimestamp = "Sürüm tarihi",
        cacheSize = "Ön bellek boyutu: %0",
        cancel = "İptal et",
        checkForUpdates = "Güncellemeleri denetle",
        clearCache = "Ön belleği temizle",
        computing = "Hesaplanıyor",
        configuration = "Yapılandırma",
        confirmForceModifyInstallationMessage = "%0 işlemi şu anda çalışıyor. " +
                "Kurulum durumunu değiştirmek için bu işlemin kapatılması gereklidir. " +
                "Kuruluma devam etmek için bu işlemler kapanmaya zorlansın mı?",
        confirmForceModifyInstallationTitle = "İşleme devam edilsin mi?",
        defaultAppStatus = "Varsayılan oyun durumu",
        downloadingRelease = "%0 sürümü indiriliyor: %1/%2",
        downloadPreReleaseVersions = "Araçların yayınlanmamış sürümleri indirilsin",
        error = "❌ Hata",
        extraInventoryItems = "Oyun içindeki Steam envanterine öğe ekle",
        fetchingToolInfo = "%0 bilgisi alınıyor",
        gameMode = "Oyuna özel ayarlar",
        inDevelopment = "Geliştirme aşamasında",
        information = "Bilgi",
        install = "Kur",
        installation = "Kurulum",
        installationError = "❌ Kurulum hatası",
        installationStatus = "Kurulum durumu",
        installationSuccess = "✅ Kurulum başarılı",
        installed = "%0 kurulu",
        language = "Dil",
        logging = "Günlük kayıtları",
        modifyInstallation = "Kurulumu düzenle",
        openDataDirectory = "Veri dizinini aç",
        openLatestReleasePage = "Son sürüm sayfasını aç",
        openLogFile = "Günlük kaydını aç",
        openOfficialForumTopic = "Resmi konu başlığını aç",
        overrideAppStatus = "Oyuna özel ayar yap",
        overrideDlcStatus = "DLC ayarı yap",
        notInstalled = "Kurulu değil",
        processStatusRunning = "Çalışıyor",
        processStatusNotRunning = "Çalışmıyor",
        refreshStatus = "Durumu yenile",
        reloadConfig = "Yapılandırmayı yenile",
        reloadConfigTooltip = "Steam işlemi çalışırken yapılandırmayı yeniden yükler",
        reloadConfigSuccess = "✅ Yapılandırma yeniden yüklendi",
        reloadConfigError = "❌ Yapılandırma yeniden yüklenirken hata",
        restoreDefaultConfiguration = "Varsayılan yapılandırmayı yükle",
        settings = "Ayarlar",
        startPage = "Başlangıç sayfası",
        startPageWelcome = "Koalageddon'un %0 sürümüne hoş geldiniz!",
        storeMode = "Mağaza ayarları",
        storeProcessStatus = "%0 işlemi durumu",
        theme = "Tema",
        themeDark = "Karanlık",
        themeLight = "Aydınlık",
        toolConfig = "%0 yapılandırması",
        removalError = "❌ Kaldırırken hata",
        removalSuccess = "✅ Başarıyla kaldırıldı",
        remove = "Kaldır",
