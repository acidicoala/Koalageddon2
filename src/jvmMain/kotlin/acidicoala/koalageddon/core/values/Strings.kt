...
sealed class Strings(
    ...
    object Turkish : Strings(
        autoInjectInventory = "Öğeleri oyun içi bir Steam envanterine otomatik olarak enjekte edin",
        appStatusOriginal = "Orijinal",
        appStatusUnlocked = "Kilidi Açıldı",
        appStatusLocked = "Kilitlendi",
        buildTimestamp = "Zaman damgası oluştur",
        cacheSize = "Önbellek boyutu: %0",
        cancel = "İptal",
        checkForUpdates = "Güncelleştirmeleri denetle",
        clearCache = "Önbelleği temizle",
        computing = "Bilgi İşlemi",
        configuration = "Yapılandırma",
        confirmForceModifyInstallationMessage = "%0 işlemi şu anda sisteminizde çalışmakta olduğu bulundu. " +
                "Yükleme durumunu değiştirmek için bu işlemi kapatmak gerekir. " +
                "Zorla kapatarak yüklemeye devam etmek istiyor musunuz?",
        confirmForceModifyInstallationTitle = "Kurulum / kaldırma işlemine devam edilsin mi?",
        defaultAppStatus = "Varsayılan oyun durumu",
        downloadingRelease = "%0 sürümü indiriliyor: %2'den %1",
        downloadPreReleaseVersions = "Araçların yayınlanma öncesi sürümlerini indirin",
        error = "❌ Hata",
        extraInventoryItems = "Oyun içi bir Steam envanterine fazladan öğeler ekleyin",
        ...
        language = "Dil",
        logging = "Günlük dosyasını yazmak",
        modifyInstallation = "Kurulumu değiştir",
        openDataDirectory = "Veri dizinini aç",
        openLatestReleasePage = "En son sürüm sayfasını aç",
        ...
        startPageWelcome = "Koalageddon v%0'a hoş geldiniz! Çeviri: @caner__karaca",
    ...
    object French : Strings(
        ...
        restoreDefaultConfiguration = "Restaurer la configuration par défaut",
        settings = "Paramètres",
        startPage = "Accueil",
