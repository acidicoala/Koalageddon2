...
sealed class Strings(
    ...
    object Polish : Strings(
        autoInjectInventory = "Automatycznie wstrzyknij przedmioty do ekwipunku steam w grze",
        appStatusOriginal = "Oryginalny",
        appStatusUnlocked = "Odblokowany",
        appStatusLocked = "Zablokowany",
        buildTimestamp = "Wersja z",
        cacheSize = "Rozmiar pamięci podręcznej: %0",
        cancel = "Anuluj",
        checkForUpdates = "Sprawdź aktualizacje",
        clearCache = "Wyczyść pamięć podręczną",
        computing = "Obliczanie",
        configuration = "Konfiguracja",
        confirmForceModifyInstallationMessage = "Proces %0 jest już uruchomiony. " +
                "By dokonać modyfikacji, trzeba zamknąć proces. " +
                "Czy chciałbyś dokonać instalacji poprzez wymuszenie zamknięcia procesu?",
        confirmForceModifyInstallationTitle = "Kontynuować instalowanie / odinstalowywanie?",
        defaultAppStatus = "Domyślny stan gry",
        downloadingRelease = "Pobieranie %0 plików: %1 z %2",
        downloadPreReleaseVersions = "Pobierz wczesną wersję narzędzi",
        error = "❌ Błąd",
        extraInventoryItems = "Wstrzyknij przedmioty do ekwipunku steam w grze",
        fetchingToolInfo = "Zbieranie %0 informacji",
        gameMode = "Tryb gry",
        inDevelopment = "Już niedługo",
        information = "Informacja",
        install = "Instaluj",
        installation = "Instalacja",
        installationError = "❌ Błąd instalacji",
        installationStatus = "Status instalacji",
        installationSuccess = "✅ Instalacja przebiegła pomyślnie",
        installed = "Zainstalowano %0",
        language = "Język",
        logging = "Zapisuj logi",
        modifyInstallation = "Modyfikuj instalacje",
        openDataDirectory = "Otwórz folder programu",
        openLatestReleasePage = "Przejdź na witryne programu",
        openLogFile = "Otwórz logi",
        openOfficialForumTopic = "Przejdź do oficjalnego forum",
        overrideAppStatus = "Wymuś stan gry",
        overrideDlcStatus = "Wymuś stan DLC",
        notInstalled = "Nie zainstalowano",
        processStatusRunning = "Uruchomiony",
        processStatusNotRunning = "Nieuruchomiony",
        refreshStatus = "Odśwież status",
        reloadConfig = "Przeładuj konfiguracje",
        reloadConfigTooltip = "Przeładowuje konfiguracje aktywnego procesu Steam",
        reloadConfigSuccess = "✅ Konfiguracja pomyślnie przeładowana",
        reloadConfigError = "❌ Wystąpił błąd podczas przeładowywania konfiguracji",
        restoreDefaultConfiguration = "Przywróć domyślną konfiguracje",
        settings = "Ustawienia",
        startPage = "Strona startowa",
        startPageWelcome = "Witaj w Koalageddon v%0",
        storeMode = "Tryb sklepowy",
        storeProcessStatus = "Status procesu %0",
        theme = "Kolor tła",
        themeDark = "Ciemny",
        themeLight = "Jasny",
        toolConfig = "%0 config",
        removalError = "❌ Wystąpił błąd podczas usuwania",
        removalSuccess = "✅ Usunięto pomyślnie",
        remove = "Odinstaluj",
        unlocker = "Odblokowywacz",
        unlockFamilySharing = "Odblokuj udostępnianie rodzinne",
        version = "Wersja v%0",
    )
}
